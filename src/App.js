import './App.css';
import Registro_ventas from './components/chats/Registro_ventas';
import Ultimas_ventas from './components/chats/Ultimas_ventas';
import Ultimas_ventas_circle from './components/chats/Ultimas_ventas_circle';
import Venta_ubicacion from './components/chats/Venta_ubicacion';
import Productos_destacados from './components/chats/Productos_destacados';
  ...
  return (
    <><div class="">
      <div class="flex flex-row">
        {/* SIDEBAR */}
        <div class="basis-2/12 px-3 border-r-2">
          {/* LOGO */}
          <div class="grid justify-items-center m-1 my-4">
            <img src="logo_my_em.svg"></img>
          </div>
          {/* SECTION */}
          <ul className="menu bg-base-100 rounded-box space-y-2 font-semibold">
            <li>
              <a className="active">
